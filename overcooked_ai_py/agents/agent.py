...
#     """
#
#     def __init__(self, other_agent, mlp, env_particle, delivery_horizon=2, logging_level=0):
#         """mlp is a MediumLevelPlanner"""
#         self.other_agent = other_agent
#         self.delivery_horizon = delivery_horizon
#         self.mlp = mlp
#         self.env_particle = env_particle
...
#         initial_env_state = self.env_particle.state
#         self.other_agent.env_particle = self.env_particle
#
...
#             self.env_particle.state = start_state
#             for joint_a in first_s_a[0]:
#                 print(self.env_particle)
#                 print(joint_a)
#                 self.env_particle.step(joint_a)
#             print(self.env_particle)
#             print("======The End======")
#
#         self.env_particle.state = initial_env_state
#
